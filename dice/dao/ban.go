...
func BanItemDel(operator database.DatabaseOperator, id string) error {
...
func BanItemSave(operator database.DatabaseOperator, id string, updatedAt int64, banUpdatedAt int64, data []byte) error {
	db := operator.GetDataDB(consts.WRITE)
...
func BanItemList(operator database.DatabaseOperator, callback func(id string, banUpdatedAt int64, data []byte)) error {
